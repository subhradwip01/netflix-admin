...
const NewUser = () => {
  ...
  const createUserHandler = async (e) => {
    ...
    await createUser(dispatch, userdata, navigate);
  };

  return (
    <div className="newUser">
      {error.has && <div className="errMsg">{error.message}</div>}
